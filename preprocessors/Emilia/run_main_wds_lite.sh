...
python main_wds_lite.py \
    ...
    --input_folder_path "gs://prod-ai-lab-speech-bucket/longtou/tmp/speechlabs/wds_v2/shard-000000.tar" \
    --wds_path emilia_pipe_lite \
    --gcs_url "gs://prod-ai-lab-speech-bucket/longtou/tmp/speechlabs/" \
